...
const Index = () => {
  return (
    ...
    <div className="bg-rose-500 lg:w-full ">
      <img className="w-full" src="https://source.unsplash.com/random" alt="LOGO" />
    </div>
...
<div>
      ...
      <div className='w-full lg:flex lg:items-center lg:w-auto hidden'>
          ...
          <div className='flex-grow items-center text-center m-3 font-dfg '>
              <img className='w-15 h-40 block  mt-4 lg:inline-block lg:mt-0 text-ml' src={apps} alt="apps" />
              <img className='w-50 h-20 block  mt-4 lg:inline-block lg:mt-0 text-ml' src={equal} alt="equal" />
          </div>  
     </div>
    ...
    <div className='flex-grow items-center text-center m-3 font-dfg '>
      <button className='bg-rose-500 md:w-1/5  '>
      SHOW ME MORE
      </button>
</div>
<div className='bg-white mt-5 w-full h-10'>  
</div>
    </>
  )
}
