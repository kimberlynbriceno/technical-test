    ...
    <div className="">
        <nav className="flex items-center p-6 flex-wrap justify-between bg-white">
            ...
            <div className="block lg:hidden"> {}
              <button onClick={handleMenu} className="flex items-center px-3 py-2 rounded border bg-rose-500 ">
              </button>
            </div>
            <div className={isMobile ? ("w-full block lg:flex lg:items-center lg:w-auto") : ("w-full lg:flex lg:items-center lg:w-auto hidden")}> 
